...
public class PlayerCamera_New : MonoBehaviour
{
    ...
    [HideInInspector] public float x, y, z = 0.0f;

    [HideInInspector] public float xSmooth, ySmooth, zSmooth = 0.0f;
...
void LateUpdate()
    {
        ...
        // }
        if (HHG_GameControl.manager.controlMode == ControlMode.touch)
        {
